...
/**
 * @brief Create or update existing edit with selective diff items.
 * Final edit can be used in ::sr_edit_batch followed by ::sr_apply_changes to configure data.
 *
 * @param[in] ly_ctx Libyang context used for generating diff.
 * @param[in] index Pointer to current index of diff.
 * @param[in] ly_diff Diff list pointer generated by libyang.
 * @param[out] edit Created/Updated edit.
 * @return Error code (::SR_ERR_OK on success).
 */
int sr_edit_update_ly2sr(struct ly_ctx *ly_ctx, uint32_t *index, struct lyd_difflist *ly_diff, struct lyd_node **edit);
