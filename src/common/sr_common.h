...
/**
 * @brief Insert node after sibling and fixes the pointer of data_info if needed.
 * @param [in] data_info
 * @param [in] sibling
 * @param [in] node
 * @return 0 on success
...
/**
 * @brief Insert node before sibling and fixes the pointer of data_info if needed.
 * @param [in] data_info
 * @param [in] sibling
 * @param [in] node
 * @return 0 on success
