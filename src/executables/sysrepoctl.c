...
help_print(void)
{
    printf(
        ...
        "                        modules is always searched (--install operation).\n"
        "  -e, --enable-feature  Enabled specific feature. Can be specified multiple times (--install, --change operations).\n"
        "  -d, --disable-feature Disable specific feature. Can be specified multiple times (--change operation).\n"
        "  -n, --no-replay       Disable replay - do not store notifications for this module (--install operation).\n"
        "  -o, --owner           Set filesystem owner of a module (--change operation).\n"
        "  -g, --group           Set filesystem group of a module (--change operation).\n"
        "  -p, --permissions     Set filesystem permissions of a module (chmod format) (--change operation).\n"
        "\n"
    );
}
