...
docker cp tmp_openwrt_image:/home/openwrt/openwrt/bin/targets/x86/generic/lede-x86-generic-generic-rootfs.tar.gz .
cat lede-x86-generic-generic-rootfs.tar.gz | docker import - sysrepo/sysrepo-netopeer2:openwrt_run
rm lede-x86-generic-generic-rootfs.tar.gz
