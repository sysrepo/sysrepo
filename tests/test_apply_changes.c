...
setup(void **state)
{
    ...
    *state = st;
    ...
    if (sr_install_module(st->conn, TESTS_DIR "/files/test.yang", TESTS_DIR "/files", NULL, 0, 0) != SR_ERR_OK) {
        return 1;
    }
    if (sr_install_module(st->conn, TESTS_DIR "/files/ietf-interfaces.yang", TESTS_DIR "/files", NULL, 0, 0) != SR_ERR_OK) {
        return 1;
    }
    if (sr_install_module(st->conn, TESTS_DIR "/files/iana-if-type.yang", TESTS_DIR "/files", NULL, 0, 0) != SR_ERR_OK) {
        return 1;
    }
    if (sr_install_module(st->conn, TESTS_DIR "/files/when1.yang", TESTS_DIR "/files", NULL, 0, 0) != SR_ERR_OK) {
        return 1;
    }
    if (sr_install_module(st->conn, TESTS_DIR "/files/when2.yang", TESTS_DIR "/files", NULL, 0, 0) != SR_ERR_OK) {
        return 1;
    }
    if (sr_install_module(st->conn, TESTS_DIR "/files/defaults.yang", TESTS_DIR "/files", NULL, 0, 0) != SR_ERR_OK) {
        return 1;
    }
...
/* TEST 1 */
static int
module_change_done_cb(sr_session_ctx_t *session, const char *module_name, const char *xpath, sr_notif_event_t event,
        void *private_ctx)
{
...
/* TEST 2 */
static int
module_update_cb(sr_session_ctx_t *session, const char *module_name, const char *xpath, sr_notif_event_t event,
        void *private_ctx)
{
    struct state *st = (struct state *)private_ctx;
    sr_change_oper_t op;
...
/* TEST 3 */
static int
module_update_fail_cb(sr_session_ctx_t *session, const char *module_name, const char *xpath, sr_notif_event_t event,
        void *private_ctx)
{
    struct state *st = (struct state *)private_ctx;
    int ret = SR_ERR_OK;
...
/* TEST 4 */
static int
module_test_change_fail_cb(sr_session_ctx_t *session, const char *module_name, const char *xpath, sr_notif_event_t event,
        void *private_ctx)
{
    struct state *st = (struct state *)private_ctx;
    sr_change_oper_t op;
...
static int
module_ifc_change_fail_cb(sr_session_ctx_t *session, const char *module_name, const char *xpath, sr_notif_event_t event,
        void *private_ctx)
{
    struct state *st = (struct state *)private_ctx;
    sr_change_oper_t op;
...
/* TEST 5 */
static int
module_change_done_dflt_cb(sr_session_ctx_t *session, const char *module_name, const char *xpath, sr_notif_event_t event,
        void *private_ctx)
{
    struct state *st = (struct state *)private_ctx;
    sr_change_oper_t op;
...
/* TEST 6 */
static int
module_change_done_when_cb(sr_session_ctx_t *session, const char *module_name, const char *xpath, sr_notif_event_t event,
        void *private_ctx)
{
    struct state *st = (struct state *)private_ctx;
    sr_change_oper_t op;
...
/* TEST 7 */
static int
module_change_done_xpath_cb(sr_session_ctx_t *session, const char *module_name, const char *xpath, sr_notif_event_t event,
        void *private_ctx)
{
    struct state *st = (struct state *)private_ctx;
    sr_change_oper_t op;
